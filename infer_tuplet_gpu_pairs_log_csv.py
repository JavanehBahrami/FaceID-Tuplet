...
# Update the evaluate_and_log_pairs function
import matplotlib.pyplot as plt
...
def process_person_folder(person_folder, embeddings, labels, folder_names, pairs_list):
    ...
    ref_files = [f for f in files if '_4.jpg' in f]
    selfie_files = [f for f in files if '_7.jpg' in f]
...
# Example usage
root_dir = '/hdd_dr/dataset/VAP/test/test_fv/eKYC/test/selfie_reference(civil)/similar_cropped_faces'
process_all_folders(root_dir, output_csv="fv_results.csv")
